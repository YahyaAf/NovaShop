...
public class UserController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<List<UserResponseDto>>> findAll(HttpServletRequest request) {
        permissionService.requireAdmin(request);
    ...
    @GetMapping("/active")
    public ResponseEntity<ApiResponse<List<UserResponseDto>>> findAllActive(HttpServletRequest request) {
        permissionService.requireAdmin(request);
    ...
    public ResponseEntity<ApiResponse<UserResponseDto>> activate(@PathVariable Long id, HttpServletRequest request) {
        permissionService.requireAdmin(request);
    ...
    public ResponseEntity<ApiResponse<Boolean>> existsByUsername(@PathVariable String username, HttpServletRequest request) {
        permissionService.requireAdmin(request);
    ...
    public ResponseEntity<ApiResponse<Long>> countActive(HttpServletRequest request) {
        permissionService.requireAdmin(request);
